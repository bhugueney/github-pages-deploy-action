...
** Quizz
#+OER_REVEAL_QUIZ_DEPENDENCY: { src: '%splugin/quiz/js/quiz.js', async: true, callback: function() { prepareQuizzes({checkAnswerText: 'Check My Answer!', preventUnanswered: true, skipStartButton: true}); } }
